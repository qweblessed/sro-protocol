...
export const TokenCol:FC<TokenProps> = ({token,setSelectedToken,setDisplayedTokens,displayedTokens}) => {
  ...
  return (
    <div  className="flex justify-center items-center bg-slate-200 border-gray-300 border-2 w-[100%] h-[30px] rounded-md text-customDeepBlue p-2 cursor-pointer font-semibold" onClick={()=>{
